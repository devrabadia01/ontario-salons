// index.mjs — Ontario Hair/Beauty Map + API using free OSM/Overpass
// Install once:  npm i express node-fetch@3 csv-stringify p-limit
...
// You can swap mirrors if one is busy:
const OVERPASS_URL = "https://overpass-api.de/api/interpreter";
// const OVERPASS_URL = "https://overpass-api.de/api/interpreter";
// const OVERPASS_URL = "https://overpass-api.nextzen.org/api/interpreter";
...
// collect exclusions (pub/bar) to avoid saloon false-positives
(
  nwr(area.a)["amenity"~"^(pub|bar)$"];
)->.ex;

// final = raw minus exclusions
(.raw; - .ex;)->.final;
...
function normalizeElement(el) {
  ...
  return {
    ...
    osm_id: el.id,
    name: tags.name || null,
    shop: tags.shop || null, // 'hairdresser' | 'beauty' | 'spa' | etc.
